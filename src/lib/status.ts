...
export const STATUS_CLASS: Record<Status, string> = {
  ...
  l1_interview:
    "bg-violet-100 text-violet-800 dark:bg-violet-500/15 dark:text-violet-300 border-violet-200/60 dark:border-violet-500/20",
  l2_interview:
    "bg-purple-100 text-purple-800 dark:bg-purple-500/15 dark:text-purple-300 border-purple-200/60 dark:border-purple-500/20",
  l3_interview:
    "bg-fuchsia-100 text-fuchsia-800 dark:bg-fuchsia-500/15 dark:text-fuchsia-300 border-fuchsia-200/60 dark:border-fuchsia-500/20",
  hr_interview:
    "bg-pink-100 text-pink-800 dark:bg-pink-500/15 dark:text-pink-300 border-pink-200/60 dark:border-pink-500/20",
  on_hold:
    "bg-amber-100 text-amber-800 dark:bg-amber-500/15 dark:text-amber-300 border-amber-200/60 dark:border-amber-500/20",
  rejected:
    "bg-red-100 text-red-800 dark:bg-red-500/15 dark:text-red-300 border-red-200/60 dark:border-red-500/20",
  ghosted:
    "bg-slate-200 text-slate-700 dark:bg-slate-600/25 dark:text-slate-300 border-slate-300/60 dark:border-slate-500/20",
  position_filled:
    "bg-orange-100 text-orange-800 dark:bg-orange-500/15 dark:text-orange-300 border-orange-200/60 dark:border-orange-500/20",
  offer:
    "bg-emerald-100 text-emerald-800 dark:bg-emerald-500/15 dark:text-emerald-300 border-emerald-200/60 dark:border-emerald-500/20",
  joined:
